...
$dompdf->setPaper('letter', 'portrait');
        ...
        .circle
         ...
         grid-template: 1fr 1fr/1fr 1fr;
          ...
          .grid-container .zone-1 {
             display: flex; /* Use display: flex; instead of position: flex; */
  ...
  foreach ($competences as $competence) {
      ...
      <div class='d-flex align-items-center'>
          <div class='circle'></div>
          <div><strong>$competence</strong></div>
      </div>
  HTML;
  }
  ...
  $html .= <<<HTML
      ...
      <div class="zone-2">
          <div class="headTitle">
              <h1>$first_name<br><b>$last_name</b></h1>
          </div>
          <div class="subTitle">
              <h1>$profession</h1>
          </div>
  ...
  foreach ($stages as $stage) {
      ...
      <ul>
          <li>
              ...
              <div class='msg-2'>{$stage['Nom']}</div>
              <div class='msg-4'>{$stage['Description']}</div>
          </li>
      </ul>
  HTML;
  }
  ...
  foreach ($projects as $projectDetails) {
      ...
      <ul>
          <li>
              <div class='msg-1'><br></div>
              <div class='msg-2'>{$projectDetails['Nom de Projet']}</div>
              <div class='msg-4'>{$projectDetails['Description project']}</div>
          </li>
      </ul>
  HTML;
  }
